...
CREATE TABLE  `tableromovil`.`entradad` (
  ...
  `entradad_nov` int(11) DEFAULT NULL,
...
INSERT INTO `tableromovil`.`entradad` VALUES  (1,'DIN0',0,11,'Electricidad','0000-00-00 00:00:00','2012-08-16 08:27:10',4,2,'thumb_r4QKihb320ZyrDF3FTISsecSS.png','thumb_r4QKihb320ZyrDF3FTISsecSS1.png',NULL),
 (2,'DIN1',0,11,'Gas','0000-00-00 00:00:00','2012-08-16 08:27:10',4,2,'thumb_m9hf8MrE4vxakTfmYvZopajRI.png','thumb_m9hf8MrE4vxakTfmYvZopajRI1.png',NULL),
 (3,'DIN2',0,11,'Agua','0000-00-00 00:00:00','2012-08-16 08:27:11',4,2,'thumb_wHc844WIdR62ABOkyseFBFEww.png','thumb_wHc844WIdR62ABOkyseFBFEww1.png',NULL),
 (4,'DIN3',0,11,'Iluminación','0000-00-00 00:00:00','2012-08-16 08:27:12',4,2,'thumb_cmduR9BYluz4FxXICzn7YGz9p.png','thumb_cmduR9BYluz4FxXICzn7YGz9p1.png',NULL),
 (5,'DIN4',1,11,'Alarma','0000-00-00 00:00:00','2012-08-08 00:44:42',4,2,'thumb_ZMTWjsJl06tWPgIjGwCQlBkN3.png','thumb_ZMTWjsJl06tWPgIjGwCQlBkN31.png',NULL),
 (6,'DIN5',1,11,'Audio 1','0000-00-00 00:00:00','2012-07-01 05:40:40',9,1,NULL,NULL,NULL),
 (7,'DIN6',0,11,'Audio 2','0000-00-00 00:00:00','2012-07-01 05:41:06',9,1,NULL,NULL,NULL),
 (8,'DIN7',NULL,NULL,NULL,'0000-00-00 00:00:00','0000-00-00 00:00:00',NULL,1,NULL,NULL,NULL);
UNLOCK TABLES;
...
INSERT INTO `tableromovil`.`escenarios` VALUES  (12,'Vacaciones familiares',1,'2012-06-30 22:28:22','2012-07-02 15:06:18','thumb_Juj3bybYl27m6e7KwonNnTC9X.png'),
 (15,'Trabajo',0,'2012-06-30 23:16:37','2012-07-01 02:11:38','thumb_xXywMkI2DKSWl70eoE0qUtsVL.png'),
...
INSERT INTO `tableromovil`.`novedades` VALUES  (1,'2012-08-08 21:33:06','Relay 1 activado',1,0,1),
 (2,'2012-08-08 21:37:44','Relay 2 activado',1,1,1),
 (3,'2012-08-08 21:37:51','Relay 3 activado',1,1,1),
 (4,'2012-08-08 21:37:57','Relay 4 activado',1,0,1),
 (5,'2012-08-08 21:38:03','Relay 5 activado',1,0,1),
 (6,'2012-08-08 21:38:11','Relay 6 activado',1,2,1),
 (7,'2012-08-16 08:09:12','Relay 7 activado',1,0,1),
 (8,'2012-08-16 08:10:47','Entrada 1 activada',1,1,1),
 (9,'2012-08-16 08:11:09','Entrada 2 activada',1,2,0),
 (10,'2012-08-16 23:22:33','Entrada 3 activada',1,0,0),
 (11,'2012-08-16 23:22:52','Entrada 4 activada',1,1,0);
UNLOCK TABLES;
...
CREATE TABLE  `tableromovil`.`salidad` (
  ...
  `salidad_nov` int(11) DEFAULT NULL,
...
INSERT INTO `tableromovil`.`salidad` VALUES  (1,'RELAY 0',1,12,'abrir_puerta',NULL,'2012-08-01 03:05:21',6,2,'thumb_Dd0Opwj9hj9PrtAFck7rJ9bSq.png','thumb_Dd0Opwj9hj9PrtAFck7rJ9bSq1.png',NULL),
 (2,'RELAY 1',1,12,'abrir_ventana',NULL,'2012-08-01 03:07:18',16,2,'thumb_diXShM71SSEbFK1EDU1RjYnhj.png','thumb_diXShM71SSEbFK1EDU1RjYnhj1.png',NULL),
 (3,'RELAY 2',1,12,'open_door',NULL,'2012-08-01 02:44:36',NULL,2,NULL,NULL,NULL),
 (4,'RELAY 3',0,12,'subir_cortina',NULL,'2012-08-01 03:06:28',16,2,'thumb_aO8d87GKV13A4lWvWwDDyRbmL.png','thumb_aO8d87GKV13A4lWvWwDDyRbmL1.png',NULL),
 (5,'RELAY 4',1,11,'Aire 1',NULL,'2012-08-07 22:43:39',7,2,'thumb_EWtTIiEEKrpPQa5Dh7B3um3AC.png','thumb_EWtTIiEEKrpPQa5Dh7B3um3AC1.png',NULL),
 (6,'RELAY 5',1,11,'Riego',NULL,'2012-08-16 23:19:16',5,2,'thumb_RJtoq1IX4SSDyrWMNKi45XC6i.png','thumb_RJtoq1IX4SSDyrWMNKi45XC6i1.png',NULL),
 (7,'RELAY 6',1,11,'Piscina',NULL,'2012-08-16 23:19:16',5,2,'thumb_VkZWC4hNrNcd8nLxDvBQ4VKmJ.png','thumb_VkZWC4hNrNcd8nLxDvBQ4VKmJ1.png',NULL),
 (8,'RELAY 7',1,11,'Bomba',NULL,'2012-08-16 23:19:19',5,2,'thumb_d7CD4z4cvSSDbUgqqaPOYR5jZ.png','thumb_d7CD4z4cvSSDbUgqqaPOYR5jZ1.png',NULL);
UNLOCK TABLES;
...
INSERT INTO `tableromovil`.`sismenu` VALUES  (1,'Administración',3,0,'0000-00-00 00:00:00','0000-00-00 00:00:00','icon-setting.png'),
 ...
 (18,'Novedades',3,0,'2012-08-17 03:50:00',NULL,'icon-default.png');
UNLOCK TABLES;
...
INSERT INTO `tableromovil`.`sispermisos` VALUES  (1,'usuarios',1,1,1,1,1,'0000-00-00 00:00:00','0000-00-00 00:00:00'),
 ...
 (14,'entradad',1,0,0,0,1,'2012-05-12 02:39:30','0000-00-00 00:00:00'),
