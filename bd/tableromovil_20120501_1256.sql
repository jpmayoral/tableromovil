...
CREATE TABLE  `tableromovil`.`salidad` (
  ...
  `salidad_relay` int(11) NOT NULL,
  `salidad_value` int(11) NOT NULL,
  `salidad_created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `salidad_updated_at` time NOT NULL,
