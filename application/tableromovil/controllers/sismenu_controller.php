...
class Sismenu_Controller extends CI_Controller {
	...
	function add_c()
	{
		...
		$this->form_validation->set_rules('sismenu_descripcion', 'sismenu_descripcion', 'trim|alpha_numeric|xss_clean');
		$this->form_validation->set_rules('sismenu_estado', 'sismenu_estado', 'trim|integer|xss_clean');
		$this->form_validation->set_rules('sismenu_parent', 'sismenu_parent', 'trim|integer|xss_clean');
		$this->form_validation->set_rules('sismenu_created_at', 'sismenu_created_at', 'trim|alpha_numeric|xss_clean');
		$this->form_validation->set_rules('sisvinculos_link', 'sisvinculos_link', 'trim|alpha_numeric|xss_clean');
		if($this->form_validation->run())
		{	
			$data_sismenu  = array();
			if($this->input->post('sismenu_descripcion'))
				$data_sismenu['sismenu_descripcion'] = $this->input->post('sismenu_descripcion');
			if($this->input->post('sismenu_estado'))
				$data_sismenu['sismenu_estado'] = $this->input->post('sismenu_estado');
			if($this->input->post('sismenu_parent'))
				$data_sismenu['sismenu_parent'] = $this->input->post('sismenu_parent');
			if($this->input->post('sismenu_iconpath'))
				$data_sismenu['sismenu_iconpath'] = $this->input->post('sismenu_iconpath');
			if($this->input->post('sismenu_created_at'))
				$data_sismenu['sismenu_created_at'] = $this->basicrud->getFormatDateToBD($this->input->post('sismenu_created_at'));
			if($this->input->post('sismenu_updated_at'))
				$data_sismenu['sismenu_updated_at'] = $this->basicrud->getFormatDateToBD($this->input->post('sismenu_updated_at'));
