<?php foreach($rows_salidad as $f): ?>
	<div data-role="fieldcontain">
		...
		<?php if($f->salidad_value == 0):?>
			<img style="width: 50px; height: 50px;" src="<?php echo base_url("css/images/icon-light-off.png"); ?>"/>
		<?php elseif ($f->salidad_value == 1): ?>
			<img style="width: 50px; height: 50px;" src="<?php echo base_url("css/images/icon-light-on.png"); ?>"/>
		<?php endif; ?>
