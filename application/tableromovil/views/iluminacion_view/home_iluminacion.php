...
<div class="ui-body ui-body-c">	
		<div data-role="fieldcontain">
			<label for="luz_1_write">Luz 1</label>
				...
				<select name="luz_1_read" id="luz_1_read" data-role="slider">
		...
		<div data-role="fieldcontain">		
			<label for="luz_2_write">Luz 2</label>
				...
				<select name="luz_2_read" id="luz_2_read" data-role="slider">
					<option value="desact">Desact.</option>
					<option value="act">Act.</option>				
				</select>
		</div>
		...
		<div data-role="fieldcontain">		
			<label for="luz_3_write">Luz 3</label>
				...
				<select name="luz_3_read" id="luz_3_read" data-role="slider">
					<option value="desact">Desact.</option>
					<option value="act">Act.</option>				
				</select>
		</div>
