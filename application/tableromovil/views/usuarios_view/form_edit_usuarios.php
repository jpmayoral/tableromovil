...
<form action="<?=base_url()?>usuarios_controller/edit_c/<?=$usuarios->usuarios_id?>" method="post" name="formEditusuarios" id="formEditusuarios">
	<div data-role="fieldcontain" >
		<label for="usuarios_id"><?=$this->config->item('usuarios_id')?>:</label>
		<input type="text" value="<?=$usuarios->usuarios_id?>" name="usuarios_id" id="usuarios_id"  readonly="readonly" data-theme="b"></input>
	</div>
	<div data-role="fieldcontain">
	...
	<div data-role="fieldcontain">
		...
		<input type="text" value="<?=$usuarios->usuarios_nombre?>" name="usuarios_nombre" id="usuarios_nombre" data-theme="b"></input>
	</div>
	<div data-role="fieldcontain">
		<label for="usuarios_apellido"><?=$this->config->item('usuarios_apellido')?>:</label>
		<input type="text" value="<?=$usuarios->usuarios_apellido?>" name="usuarios_apellido" id="usuarios_apellido" data-theme="b"></input>
	</div>
	<div data-role="fieldcontain">
		<label for="usuarios_email"><?=$this->config->item('usuarios_email')?>:</label>
		<input type="text" value="<?=$usuarios->usuarios_email?>" name="usuarios_email" id="usuarios_email" data-theme="b"></input>
	</div>
	<div data-role="fieldcontain">
		<label for="usuarios_direccion"><?=$this->config->item('usuarios_direccion')?>:</label>
		<input type="text" value="<?=$usuarios->usuarios_direccion?>" name="usuarios_direccion" id="usuarios_direccion" data-theme="b"></input>
	</div>
	<div data-role="fieldcontain">
		<label for="usuarios_telefono"><?=$this->config->item('usuarios_telefono')?>:</label>
		<input type="text" value="<?=$usuarios->usuarios_telefono?>" name="usuarios_telefono" id="usuarios_telefono" data-theme="b"></input>
	</div>
	<div data-role="fieldcontain">
	...
	<div data-role="fieldcontain">
		...
		<select name="perfiles_id" id="perfiles_id" data-native-menu="false">
			<?php foreach ($perfiles as $f): ?>
				<?php if($f->tabgral_id == $usuarios->perfiles_id): ?>
